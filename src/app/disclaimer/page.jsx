      ...
      <Container>
        <div className={styles.disclaimer}>
          ...
          <p className="text-uppercase">
            ...
            TERMS. IF YOU DO NOT AGREE TO ABIDE BY THE ABOVE, PLEASE DO NOT MAKE
            ANY USE OF THE SERVICE.
          </p>
          <p>
            When using these Services, you shall be subject to any posted
            guidelines or rules applicable to such Services. There may be other
            terms applicable to our relationship with you.
          </p>
          <p>
          ...
          <p>
            ...
            accept any responsibility for the content on, or the use, of such
            linked site. We are not responsible and have no control over the
            content of linked sites nor do we guarantee the content of such
            sites. All products, services, and deals mentioned by linked sites
            are provided by third parties and are subject to change without
            notice and are subject to such restrictions, limitations,
            availability, conditions, and qualifications as the third party
            specifies.
          </p>
          <p className="text-uppercase">
            DO NOT RELY ON THE SERVICES OR THE LINKED SITES. RELY ONLY ON YOUR
            OWN INDEPENDENT JUDGEMENT AFTER HAVING DECIDED WHETHER TO TAKE
            INDEPENDENT ADVICE FROM AN APPROPRIATELY QUALIFIED PERSON.
          </p>
          <p>
            <span className="fst-italic">
          ...
          <p>
            ...
            by any error, omission, deletion, defect, interruption, failure of
            performance, delay in operation or transmission, computer virus,
            ...
            contract, negligence, tortious behavior, or under any other cause of
            action.
          </p>
          <p>
          ...
          <p>
            Your rights which cannot be excluded: Nothing in this disclaimer
            purports to exclude, restrict or modify, or has the effect of
            excluding, restricting or modifying the application of, or the
            exercise of a right conferred by, or our liability for a failure
            <strong> (“relevant breach”)</strong> to comply with, a right (such
            as a guarantee) that applies to our relationship with you which
            cannot by any statutory law applicable to that relationship be
            excluded, restricted or modified. Exception: However where any such
            law applies but also permits, and you are acquiring goods or
            services from us which are other than those of a kind ordinarily
            acquired for personal, domestic or household use or consumption and
            we establish that it is fair or reasonable for us to rely on this
            exception, we limit our liability to you for a relevant breach- in
            the case of goods, to one or more of
          </p>
          <ul>
            <li>
            ...
            <li>
              The payment of the cost of having the goods repaired and - in the
              case of services, to one or more of
            </li>
            <li>The supplying of the services again.</li>
            <li>
          ...
          <p>
            ...
            <Link
              ...
              target="_blank"
            >
              www.projectleadersmagazine.com/cookie-policy.
            </Link>
          </p>
          <p>
          ...
          <address>
            <p>
              <strong>Contacts:</strong> Contact details for matters relating to
              this disclaimer are: <br /> <strong>Email:</strong>
