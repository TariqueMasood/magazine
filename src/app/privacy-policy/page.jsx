  ...
  return (
    <div className={styles.wrapper}>
      <Container>
        ...
        <div className={styles.privacyDiveder}></div>
        <h6>Introduction </h6>
        <p>
          This Privacy Policy explains how personal data is collected and used
          by BizClik Media Limited (company number: 06039571) and any other
